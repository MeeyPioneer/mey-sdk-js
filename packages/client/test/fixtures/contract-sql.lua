-- $GOPATH/src/github.com/meycoin/mey/bin/meyluac --abi contract-sql.abi.json contract-sql.lua contract-sql.out
-- $GOPATH/src/github.com/meycoin/mey/bin/meyluac --payload ./contract-sql.lua > contract-sql.txt
