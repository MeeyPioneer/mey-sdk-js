...
describe('Address', () => {
    ...
    it('should recognize system addresses', () => {
        const systemAddresses = ['mey.system', 'mey.enterprise', 'mey.name'];
        const nonSystemAddresses = ['meysystem', 'AmNwCvHhvyn8tVb6YCftJkqsvkLz2oznSBp9TUc3k2KRZcKX51HX'];
        const invalidAddresses = ['mey.something', 'AmNwCvHhvyn8tVb6YCftJkqsvkLz2oznSBp9TUc3k2KRZcKX51HXABC'];
    ...
    it('should be able to set custom system addresses', () => {
        ...
        assert.isFalse(new Address('mey.system').isSystemAddress());
    });
